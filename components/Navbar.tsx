      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-5">
            <a href="tel:+212654352802" className="hidden lg:flex items-center space-x-3 text-emerald-800 font-bold text-xs bg-stone-50 px-5 py-2.5 rounded-2xl border border-stone-100 hover:bg-emerald-50 transition-all shadow-sm">
